...
Place the Python script in the /scripts dir inside your `NUKE_PATH` (see my [previous post](http://fredrikaverpil.github.io/2011/10/28/nuke-63-small-studio-setup-for-windows-osx/) on setting this up). Add the following to your `menu.py`:
