...
**Note:** Before reading on, you may want to skip this alltogether and go directly to my [pre-built Python wheels](https://github.com/fredrikaverpil/pyside2-wheels) and the most up to date build recipes there.
