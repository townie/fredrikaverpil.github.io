...
This is yet another aging sign of Python 2.x. Personally, I'm developing with Python 3.5 as the interpreter of choice in my IDE and I make sure my code is backwards compatible with Python 2.7, which is actually very easy for the most part. I think that the [VFX Reference Platform](http://www.vfxplatform.com) should plan ahead (starting now) for a move onto Python 3.5 as there are great reluctancy in the industry towards this move. It'll involve a lot of code porting, yes, but with enough headsup time this shouldn't be blocking such a move. In a developer's world, this is how it works. You can't hold on to old code forever.
